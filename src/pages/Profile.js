        ...
        <div>
            ...
            <Mobile>
                <div className='row'>
                    ...
                    <div className='col-md-8'>
                        <div className='user-container d-flex align-items-center'>
                            <div className=' col-md-2 user-img mb-5 mt-5 '>
                        ...
                        <div className='button-container d-flex align-items-center justify-content-center' style={{ marginBottom: '20px' }}>
                            <div className='button-container' style={{ display: 'inline-block', width: '250px', justifyContent: 'space-between' }} >
                                <button onClick={() => handleTabChange('post')} className={activeTab === 'post' ? 'active' : ''}><RiFolderMusicLine className='me-2' size='20' /></button>
                                <button onClick={() => handleTabChange('saved')} className={activeTab === 'saved' ? 'active' : ''}><FiBookmark className='me-2' size='20' /></button>
                                <button onClick={() => handleTabChange('playlist')} className={activeTab === 'playlist' ? 'active' : ''}><TbPlaylist className='me-2' size='20' /></button>
                            </div>
                        </div>
